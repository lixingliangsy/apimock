...
export default function Home() {
  ...
  async function runStudio(e?: FormEvent) {
    ...
    try {
      ...
      // also mirror into common keys so rules that look for commits/text/endpoints still fire
      for (const k of ['commits', 'text', 'article', 'endpoints', 'notes', 'goal', 'topic']) {
  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href="https://apimock.lxsaihub.com/" />
        <script type="application/ld+json">{`{"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "What does MockDeck generate?", "acceptedAnswer": {"@type": "Answer", "text": "Mock REST and JSON endpoints from OpenAPI or a schema."}}, {"@type": "Question", "name": "Does it support dynamic data?", "acceptedAnswer": {"@type": "Answer", "text": "Yes - faker-style generators and stateful sequences."}}, {"@type": "Question", "name": "Can agents use it?", "acceptedAnswer": {"@type": "Answer", "text": "Yes - agent tool calls can hit the mock to develop offline."}}, {"@type": "Question", "name": "Is it a test double?", "acceptedAnswer": {"@type": "Answer", "text": "It is a contract mock; pair it with the real API in integration."}}, {"@type": "Question", "name": "How is it shared?", "acceptedAnswer": {"@type": "Answer", "text": "A hosted mock URL per project; Enterprise self-hosts."}}, {"@type": "Question", "name": "Does it validate schemas?", "acceptedAnswer": {"@type": "Answer", "text": "It can assert requests and responses against the spec."}}]}`}</script>
      ...
      <div className="min-h-screen bg-white text-slate-900">
        ...
        <section id="definition" className="py-20 bg-slate-50">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold mb-4">MockDeck - definition</h2>
        ...
        <section id="product-faq" className="py-20">
          <div className="max-w-3xl mx-auto px-6">
            <h2 className="text-3xl font-extrabold text-center mb-10">MockDeck - frequently asked questions</h2>
