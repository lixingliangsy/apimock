 ...
 *
 * <script src="https://YOUR_DOMAIN/widget.js" data-host="https://YOUR_DOMAIN" data-product="apimock" async></script>
 *
...
(function () {
  ...
  host = host.replace(/\/+$/, "");
  var product = (tag && tag.getAttribute("data-product")) || "apimock";
  ...
  function build() {
    ...
    var panel = null;
    var sessionKey = (product || "apimock") + "_chat_session";
